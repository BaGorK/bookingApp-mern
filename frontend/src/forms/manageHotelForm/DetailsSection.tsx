  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <div className='flex gap-4'>
        <label className='text-gray-700 flex-1 text-sm font-bold '>
          ...
          <input
            ...
            className='border bg-gray-100 rounded w-full py-1 px-2 font-normal'
          />
          {errors.city && (
            <p className='text-red-700 text-sm font-normal'>
              {errors.city.message}
      ...
      <label className='text-gray-700 flex-1 text-sm font-bold '>
        Description
        <textarea
          defaultValue='some test description'
          rows={10}
      ...
      <label className='text-gray-700 max-w-[50%]  text-sm font-bold '>
        ...
        <select
          ...
          className='rounded p-2 w-full text-gray-700 font-normal'
        >
